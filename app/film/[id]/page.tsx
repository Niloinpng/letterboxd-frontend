        ...
        <div className="flex flex-col">
          <div className="flex flex-row ">
            <div className="w-3/4 flex flex-col gap-4">
              <h1 className="text-6xl font-ibm font-bold text-branco">
                {film.title}
              </h1>
              ...
              <div className="flex flex-wrap gap-1 pt-2">
                {film.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="bg-cinzaescuro text-cinza text-sm px-2 py-1 rounded"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="w-1/4 flex flex-col items-center gap-2 justify-between">
              ...
              <div className="flex flex-col items-center gap-2">
                <button
                  className="bg-cinzaescuro w-44 text-cinza text-sm px-6 py-2 rounded-lg hover:bg-opacity-50 transition"
